/**
 * AI assistant overlay: next-step suggestions per project.
...
const ERROR_TEXT: Record<string, string> = {
  not_configured: 'AI 助手尚未配置。请由 owner 在设置中添加 provider、API Base、模型和 API Key。',
