...
/** Project IDs are owner-generated stable strings; names are always mutable. */
export type SubjectId = string;

export type AggregateGroup = string;

export interface SubjectDef {
  id: SubjectId;
  displayName: string;
  aggregateGroup: AggregateGroup | null;
  /** 前端色板键；具体颜色在 web 层 token 中定义，保证深浅两套。 */
  colorId: string;
  sortOrder: number;
  /** Archived projects remain available in historical sessions and summaries. */
